...
public class Matrix {
    ...
    /**
     * Makes a matrix from 2d array with condition if constants should be refreshed
     * or not
     * 
     ...
     * @throws IllegalArgumentException when matrix is empty or given number exceeds
     *                                  matrix shape
     */
     ...
     * @throws IllegalArgumentException when matrix is empty or row number exceeds
     *                                  matrix shape
     */
     ...
     * 
     * @throws IllegalArgumentException when number of rows from second matrix is
     *                                  not equal to number of columns from
     *                                  first matrix
     ...
     * @return Result of multiplication as matrix
     * @throws IllegalArgumentException when height of second matrix is not equal to
    ...
    /**
     * Sets boolean value if show shortened version of matrix on toString method or
     * not
     * 
    ...
    /**
     * Creates matrix with random doubles
     * 
     * @param rows - number of rows
     * @param columns - number of columns
     * @return Matrix rows x columns of random doubles
     */
    public static Matrix random(int rows, int columns) {
        if(rows <= 0 || columns <= 0) {
            throw new RuntimeException("Rows and columns cannot be less than 0");
        }
        ...
        for(int i = 0; i < rows; i++) {
            for(int j = 0; j < columns; j++) {
                a.setIndividualData(i, j, r.nextDouble());
            }
        }        
